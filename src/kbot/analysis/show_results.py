    ...
    try:
        ...
        # --- Manuelle Simulation ---
            ...
            if results:
                ...
                print(f"Liquidiert:         {'JA, am ' + liq_date.strftime('%Y-%m-%d') if results['liquidation_date'] else 'NEIN'}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="KBot Backtest Ergebnis-Analyse")
