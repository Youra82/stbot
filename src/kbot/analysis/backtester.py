# /root/utbot2/src/kbot/analysis/backtester.py
import os
import pandas as pd
import numpy as np
import json
...
from kbot.strategy.stochrsi_engine import StochRSIEngine # NEU
...
def load_data(symbol, timeframe, start_date_str, end_date_str):
    ...
    try:
        ...
        # Prüfe auf alte 'utbot2' oder neue 'kbot' Keys
        api_setup = None
        if 'kbot' in secrets_cache: api_setup = secrets_cache['kbot'][0]
