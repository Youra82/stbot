# /root/stbot/src/stbot/analysis/backtester.py
import os
import pandas as pd
import numpy as np
import json
...
from stbot.strategy.ichimoku_engine import IchimokuEngine
...
def load_data(symbol, timeframe, start_date_str, end_date_str):
    ...
    try:
        ...
        if 'stbot' in secrets_cache:
            api_setup = secrets_cache['stbot'][0]
