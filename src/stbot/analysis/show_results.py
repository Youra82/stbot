# Pfad: /home/matola/stbot/src/stbot/analysis/show_results.py
# src/stbot/analysis/show_results.py (Angepasst für STBot EMA/MACD/RSI Strategie)
import os
import sys
import json
import pandas as pd
...
def run_single_analysis(start_date, end_date, start_capital):
    # *** ÄNDERUNG: Titel von TitanBot zu STBot ***
    ...
    for filename in config_files:
        ...
        try:
            ...
            # run_smc_backtest funktioniert auch für die Indikator-Strategie
        ...
        try:
            ...
            if not data.empty:
                strategies_data[filename] = {
                    ...
                    'smc_params': config.get('strategy', {}), # Bleibt smc_params zur Kompatibilität mit Simulator
                    'risk_params': config.get('risk', {})
                }
            else:
