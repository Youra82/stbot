...
CONFIGS_DIR="src/stbot/strategy/configs"
...
# Nur Configs und settings.json stagen — nichts anderes
...
git commit -m "Update: SR-Konfigurationen aktualisiert ($TIMESTAMP)"
